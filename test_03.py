...
class Test(testlib.TestCase):
    ...
    def do_test(self, ls, testo, expected_lista, expected_parola, expected_ls):
        ...
        self.check(ls1_bis, expected_ls, None,
                   'non viene modificata correttamente la lista in input')
        return 1
    ...
    def test_segreto(self):
        ...
        # print(testo)
        parole = [
            'umhv', 'gyhdszwyawyqiuut', 'ukwbrckvmrbavxshsq', 'ypagqbw', 'hmxneygmgyqgbyetr', 'xuffyponjvngcyz',
        ...
        expected_lista = [
            'iocavknzxv', 'eqtrhfgfk', 'cnazdo', 'jlwcdoxexkgcridekso', 'qgsc', 'hztoyh',
        ...
        expected_ls = [
            'ukwbrckvmrbavxshsq', 'cdeuiynijdshccg', 'fdl', 'hdjushh', 'odauicbwojstnwyxfej', 'znx',
